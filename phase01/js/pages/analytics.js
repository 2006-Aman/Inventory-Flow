...
function renderKPIs() {
    ...
    // Card 2: Stock Turnover (Units Sold / Total Current Stock)
    ...
    allSales.forEach(s => {
        ...
        if (!catSalesMap[category]) {
            catSalesMap[category] = { revenue: 0, units: 0 };
        }
        catSalesMap[category].revenue += rev;
        catSalesMap[category].units += qty;
    });
